cities = {'chicago', 'vancouver', 'milwaukee', 'las vegas'}
cities2 = {'new york', 'san francisco', 'chicago', 'las vegas'}

print(f'1: {cities}')
print(f'2: {cities2}')
print(f'3: {cities.intersection(cities2)}')
...
setcomp = {x**2 for x in range(1,10)}
print(setcomp)
